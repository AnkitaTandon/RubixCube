...
public class CubePainter extends JPanel implements ActionListener, ChangeListener, MouseListener {
	...
	public void initializeComponents() {
		...
		start.setLocation(40, 10); start.setSize(80,20);
		add(start);
		...
		animSpeed.setLocation(450, 0); animSpeed.setSize(200, 40);
		add(animSpeed); 
		animSpeed.addChangeListener(this);

		inputScramble = new JTextField(scramble); 
		inputScramble.setLocation(160, 47); inputScramble.setSize(400, 35); 
		...
		applyScramble.setLocation(590, 45); applyScramble.setSize(90,20);
		add(applyScramble);
		applyScramble.addActionListener(this);
		
		randomize = new JButton("RANDOM");
		randomize.setLocation(590, 75); randomize.setSize(90,20);
		add(randomize);
		...
		setInputs.setLocation(310, 650); setInputs.setSize(100, 30);
		add(setInputs);
	...
	public void paintComponent(Graphics g) {
		...
		if(!inSolution) {
			...
			g.drawString("Hold the cube such that " + instructions[0] + " is facing up, " +
					...
					50, 130);
			//g.drawString("Enter the top colors.",50, 150);
